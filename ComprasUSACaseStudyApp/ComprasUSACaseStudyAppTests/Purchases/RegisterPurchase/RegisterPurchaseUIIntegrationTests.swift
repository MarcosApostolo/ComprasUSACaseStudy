...
final class RegisterPurchaseUIIntegrationTests: XCTestCase {
    ...
    // MARK: Helpers
    func makeSUT(file: StaticString = #file, line: UInt = #line) -> (sut: RegisterPurchaseViewController, loader: StateLoaderSpy) {
